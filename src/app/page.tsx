...
import { HeartPulse, Home as HomeIcon, Stethoscope, Clock, Users } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] md:h-[80vh] w-full">
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-center text-center text-primary-foreground p-4">
          ...
          <p className="mt-4 max-w-2xl text-lg md:text-xl font-light">
            Primary Care & 24/7 Homecare in Bali
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <Button asChild size="lg" className="bg-accent text-accent-foreground hover:bg-accent/90">
              <Link href="/homecare">Book Appointment</Link>
            </Button>
            <Button asChild size="lg" variant="outline" className="border-accent text-accent hover:bg-accent hover:text-accent-foreground">
              <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer">WhatsApp Now</a>
            </Button>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center">
            ...
            <p className="text-muted-foreground mt-2">
              Our medical team is ready to assist you around the clock, any day of the week.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <Users className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-bold">Professional Doctors</h3>
            <p className="text-muted-foreground mt-2">
              Benefit from consultations with our experienced and certified medical professionals.
            </p>
          </div>
          <div className="flex flex-col items-center">
            <HomeIcon className="w-12 h-12 text-primary mb-4" />
            <h3 className="text-xl font-bold">Homecare Services</h3>
            <p className="text-muted-foreground mt-2">
              Receive high-quality medical care in the comfort of your home or hotel.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
              Comprehensive medical solutions tailored to your needs, from general checkups to specialized homecare.
            </p>
          </div>
                ...
                <Card key={service.title} className="overflow-hidden transition-shadow hover:shadow-lg">
                  ...
                  <CardContent>
                    ...
                    <Button asChild variant="link" className="p-0 text-primary">
                      <Link href={`/services#${service.title.toLowerCase().replace(/ /g, '-')}`}>Learn More</Link>
                    </Button>
                  </CardContent>
                </Card>
              )
      ...
      <section className="bg-background py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold">Trusted & Professional</h2>
            <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
              Our certified doctors and modern facilities ensure you receive the best care.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6">
               ...
               <Button asChild variant="outline" className="mt-8">
                  <Link href="/about">See All Staff</Link>
                </Button>
            </div>
      ...
      <section className="bg-card py-20">
        <div className="container mx-auto">
          <div className="text-center mb-12">
             ...
             <p className="text-muted-foreground mt-2">@balimedcare_official on Instagram</p>
          </div>
           ...
           <Card className="max-w-4xl mx-auto p-8 text-center">
             ...
             <CardContent>
              <p className="text-muted-foreground mb-6">
                Our clinic is located in the heart of Bali. We serve a wide area across the island. Our AI-powered system constantly updates our service coverage based on homecare requests. See it in action on our Homecare page!
              </p>
              <div className="flex flex-col md:flex-row justify-center items-center gap-8 text-lg">
                <p><strong>Phone:</strong> +62 123 456 7890</p>
                <p><strong>Email:</strong> contact@balimedcare.com</p>
              </div>
              <Button asChild className="mt-8">
                <Link href="/homecare">Request Homecare</Link>
              </Button>
             </CardContent>
           </Card>
         </div>
